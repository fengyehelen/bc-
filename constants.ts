...
export const TRANSLATIONS = {
  en: {
    ...
    phone: 'Phone Number', password: 'Password', username: 'Username', verifyCode: 'SMS Code', getCode: 'Get Code', appName: 'BetBounty',
  ...
  zh: {
    ...
    phone: '手机号码', password: '登录密码', username: '后台账号', verifyCode: '短信验证码', getCode: '获取验证码', appName: '博彩宝',
  ...
  // ... (Other languages keep similar structure, assuming existence)
  id: {
     ...
     phone: 'Nomor HP', password: 'Kata Sandi', username: 'Nama Pengguna', verifyCode: 'Kode SMS', getCode: 'Dapatkan Kode', appName: 'PusatCuan',
